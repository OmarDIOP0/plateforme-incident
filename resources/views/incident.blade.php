            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <form action="/incident" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="mb-6 mx-12 mt-5">
                        ...
                        <input type="text" id="libelle" name="libelle" placeholder="Saisir le libelle" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <div class="ui red">
                            @error('libelle')
                    ...
                    <div class="mb-6 mx-12 ">
                      ...
                      <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mb-6 mx-12">Declarer</button>
                </form>
